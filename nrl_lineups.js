...
window.NRL_LINEUPS = {
  ...
  "teams": {
    ...
    "PEN": ["Dylan Edwards", "Thomas Jenkins", "Blaize Talagi", "Casey McLean", "Casey Mclean", "Brian To'o", "Brian Too", "Jack Cole", "Nathan Cleary", "Moses Leota", "Mitch Kenny", "Lindsay Smith", "Isaiah Papali'i", "Isaiah Papalii", "Liam Martin", "Isaah Yeo", "Jack Cogger", "Scott Sorensen", "Liam Henry", "Billy Phillips", "Luke Garner", "Freddy Lussick"],
